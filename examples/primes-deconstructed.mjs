/**
* Example agent to demonstrate generating prime numbers (to a optional limit) - Using ES6 + deconstructed return
*
...
export let id = 'primes';

export function worker(finish, settings) {
	let agent = this;
	_.defaults(settings, {
		delay: 0,
		limit: 10000,
